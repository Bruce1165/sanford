#!/usr/bin/env python3
"""
Verify triple-screen migration objects without changing data.

Usage:
  python3 scripts/migrations/verify_triple_screen_migrations.py
"""
...
REQUIRED_TABLES = [
    "triple_screen_pool",
    "triple_screen_signals",
]

REQUIRED_INDEXES = [
    "ux_triple_pool_biz_key",
    "idx_triple_pool_code",
    "idx_triple_pool_active",
    "idx_triple_pool_import_batch",
    "ux_triple_sig_biz_key",
    "idx_triple_sig_code_date",
    "idx_triple_sig_task_date",
    "idx_triple_sig_new_entry_date",
    "idx_triple_sig_pool",
]
...
def main() -> int:
    ...
    try:
        ...
        print("[OK] Triple-screen migration objects verified.")
        return 0
    finally:
        conn.close()
